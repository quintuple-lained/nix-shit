...
{ config, lib, pkgs, modulesPath, ... }: {
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/81249ffa-42a4-4469-accb-101e38771b2d";
    fsType = "btrfs";
    options = [ "compress=zstd" "discard=async" ];
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/303D-EE46";
    fsType = "vfat";
  };
  ...
  swapDevices =
    [{ device = "/dev/disk/by-uuid/faacd0be-bd46-4bd3-b24e-5882884f3a2c"; }];
